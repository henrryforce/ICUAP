...
@section('contenido')
    ...
    <div class="flex justify-center ">
        <div class=" rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-2">Nombre de investigador:{{ $inves->nombres }}
                    {{ $inves->apellido_paterno }} {{ $inves->apellido_materno }}</div>
            ...
            <div class="px-6 pt-4 pb-2">
                @foreach ($areas as $area)
                    <span
                        class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#{{ $area->nombre }}</span>
                @endforeach
        ...
        <div class="flex justify-center pt-20">
            <div class=" rounded overflow-hidden shadow-lg">
                <ul class="nav nav-tabs flex flex-col md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4"
                    id="tabs-tab3"role="tablist" data-tabs-toggle="#myTabContent" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="#tabs-home3"
                            ...
                            id="tabs-home-tab3" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false"
                            aria-controls="tabs-home3" aria-selected="true">Articulos</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="#tabs-profile3"
                            class="nav-link w-full block font-medium text-xs leading-tight uppercase border-x-0 border-t-0 border-b-2 border-transparent
                ...
                @foreach ($articulos as $articulo)
                    <div class="mx-5 my-5 bg-white shadow-md px-5 py-3 rounded-xl">
                        <div class="px-6 py-4">
                            ...
                            <div class="mt-2">
                                <a class="decoration-solid">Año de publicación: </a> <a>{{ $articulo->ano_publicacion }}
                                </a>
                            </div>
                            <div class="mt-2">
